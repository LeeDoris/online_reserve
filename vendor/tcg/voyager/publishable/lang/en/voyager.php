...
return [
    ...
    'dimmer' => [
        ...
        'page_text'      => 'You have :count :string in your database. Click on button below to view all Tables.',
        'post'           => 'Post|Posts',
        'post_link_text' => 'View all posts',
        'post_text'      => 'You have :count :string in your database. Click on button below to view all Reservations.',
        'user'           => 'User|Users',
