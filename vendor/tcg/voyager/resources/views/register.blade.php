            ...
            <div class="clearfix">
                <div class="col-sm-12 col-md-10 col-md-offset-2">
                    <div class="logo-title-container">
                        ...
                        @if($admin_logo_img == '')
                            <img class="img-responsive pull-left logo hidden-xs animated fadeIn" src="{{ voyager_asset('images/logo-new.png') }}" alt="Logo Icon">
                        @else
        ...
        <div class="col-xs-12 col-sm-5 col-md-4 login-sidebar">
            ...
            <div class="login-container" style="top: 30%">
                ...
                <form action="{{ route('register') }}" method="POST">
                    ...
                    <div class="form-group form-group-default" id="telephoneGroup">
                        <label>Telephone</label>
                        <div class="controls">
                            <input type="text" name="telephone" id="telephone" value="{{ old('telephone') }}" placeholder="Telephone" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group form-group-default" id="passwordGroup">
                        ...
                        <div class="controls">
                            <input type="password" name="password-confirm" placeholder="Password Confirm" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <button type="button" class="btn btn-block login-button" style="float: right">
                        <a href="{{ url('/admin/login') }}"> <span class="signin">LOGIN</span></a>
                    </button>
